...
- Thread count: `nproc - 2` (or `sysctl hw.ncpu - 2` on macOS), reserving 2 logical CPUs for system headroom; passed to x265 only via `pools=` encopts — x264 uses HandBrakeCLI's default threading
